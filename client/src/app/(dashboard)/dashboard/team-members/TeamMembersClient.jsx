...
export default function TeamMembersClient({ initialItems = [], initialDepartments = [] }) {
  ...
  // Sync props to state in case of router.refresh()
  useEffect(() => {
  ...
  const onSubmit = async (e) => {
    ...
    if (!editingId && !imageFile)
      return toast.error("Team member image is required");
    setUploading(true);
        ...
        >
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <FormField
              label="Department"
              htmlFor="tm-dept"
              hint="From Departments — optional"
            >
              <DashboardSelect
                id="tm-dept"
                fullWidth
            ...
            <FormField
              label="Email"
              htmlFor="tm-email"
              hint="Optional — for internal contact only"
            >
              <input
                id="tm-email"
                type="email"
            ...
            >
              <input
                id="tm-skills"
                className={inputCls}
                placeholder="Fact-checking, data, video …"
                value={form.skills}
            ...
            <FormField
              label="Priority"
              htmlFor="tm-pri"
              hint="Higher sorts first on the public team page"
            >
              <input
                id="tm-pri"
                type="number"
          ...
          <FormField
            ...
            hint={
              editingId
                ...
                : "Required — click to upload; max 1 image"
            }
          >
            <ImageUploadPreview
              file={imageFile}
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            setForm({
                              ...
                              phone: it.phone || "",
                              departmentId:
                                it.departmentId || it.department?.id || "",
